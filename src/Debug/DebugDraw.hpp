...
namespace GTS {
	...
	class DebugDraw {
		...
		static void DrawRectangle(float rotation, const glm::vec3& origin, float width, float length, int lifetimeMS = 10, const glm::vec4& color = { 1.0f, 0.0f, 0.0f, 1.0f }, float lineThickness = 1.0f);
