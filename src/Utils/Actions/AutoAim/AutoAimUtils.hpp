...
namespace GTS {
	...
	bool AutoAim_Sneak_TryButtSlam(Actor* giant, bool& left_butt, AimAssistResult* out_result = nullptr);
	...
	void SetStompBlendValues(Actor* giant, float x, float y, std::string_view source = "Default");
}